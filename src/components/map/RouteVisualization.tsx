...
export const RouteVisualization: React.FC<RouteVisualizationProps> = ({
  ...
  const sortedPois = useMemo(() => {
    ...
    const filteredPois = itineraryId 
      ? pois.filter(poi => poi.itineraryId === itineraryId)
      : pois;
  ...
  return (
    <>
      {Object.entries(routesByItinerary).map(([id, { pois: itineraryPois, color: itineraryColor }]) => {
