          ...
          <section>
            ...
            <div className="space-y-2">
              {[
                ...
                { icon: '📍', label: 'Location Services', value: 'Enabled', href: '/settings/location' },
                { icon: '💾', label: 'Offline Downloads', value: '2.3 GB', href: '/settings/downloads' },
                { icon: '🔔', label: 'Notifications', value: 'On', href: '/settings/notifications' },
              ].map((item) => (
                <button
                  key={item.label}
